...
public class TarefaDTO {
    ...
    // Armazena o título enviado pelo cliente.
    @NotBlank(message = "Título é obrigatório")
    private String titulo;

    // Armazena o responsável enviado pelo cliente.
    ...
    // Devolve o título recebido no DTO.
    ...
    // Devolve o responsável recebido no DTO.
    public String getResponsavel() {
        return responsavel;
    }

    // Recebe e guarda um novo responsável.
